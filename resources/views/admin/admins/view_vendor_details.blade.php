                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $vendorDetails['vendor_personal']['address'] }}" id="vendor_address"
                                name="vendor_address" placeholder="Enter Address" readonly="">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img style="width: 150px;" src="{{ url('admin/images/photos/'.$vendorDetails['image']) }}">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $vendorDetails['vendor_business']['address_proof']}}"
                                readonly="">
                        </div>
